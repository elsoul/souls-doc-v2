...
const actions = [
  ...
  {
    title: 'doc:actions.basic.title',
    body: 'doc:actions.basic.body',
  ...
  {
    title: 'doc:actions.api.title',
    body: 'doc:actions.api.body',
  ...
  {
    title: 'doc:actions.worker.title',
    body: 'doc:actions.worker.body',
